...
public class CompanyRestControllerTest extends BaseTest {
    ...
    public void getPresentEmployeesTest() throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.get("/getPresentEmployees.do")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(Matchers.equalTo("[{\"name\":\"张三\",\"birthday\":\"2000-01-10T00:00:00.000+08:00\",\"gender\":\"男\",\"email\":\"2019302110260@whu.edu.cn\",\"identifyNumber\":\"5\",\"accountNumber\":5,\"password\":\"123\",\"experiences\":[{\"accountNumber\":5,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1521,\"startTime\":\"2010-01-10T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":5,\"companyId\":1,\"startTime\":\"2010-01-10T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"51的表现\"}}]},{\"name\":\"李四\",\"birthday\":\"2001-01-11T00:00:00.000+08:00\",\"gender\":\"女\",\"email\":\"2019302110261@whu.edu.cn\",\"identifyNumber\":\"6\",\"accountNumber\":6,\"password\":\"456\",\"experiences\":[{\"accountNumber\":6,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1621,\"startTime\":\"2011-01-11T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":6,\"companyId\":1,\"startTime\":\"2011-01-11T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"61的表现\"}}]}]")))
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void getCompanyByCompanyIdTest()throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.get("/getCompanyByCompanyId.do?companyId=1")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(Matchers.equalTo("{\"companyId\":1,\"name\":\"我的公司1\",\"legalRepresentativeName\":\"Alan\",\"email\":\"lihaoc@whu.edu.cn\",\"address\":\"湖北省武汉市洪山区\",\"phone\":\"88555273\",\"experiences\":[{\"accountNumber\":5,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1521,\"startTime\":\"2010-01-10T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":5,\"companyId\":1,\"startTime\":\"2010-01-10T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"51的表现\"}},{\"accountNumber\":6,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1621,\"startTime\":\"2011-01-11T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":6,\"companyId\":1,\"startTime\":\"2011-01-11T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"61的表现\"}},{\"accountNumber\":7,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1721,\"startTime\":\"2012-01-12T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":true,\"assessment\":{\"accountNumber\":7,\"companyId\":1,\"startTime\":\"2012-01-12T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"71的表现\"}},{\"accountNumber\":8,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1821,\"startTime\":\"2013-01-13T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":true,\"assessment\":{\"accountNumber\":8,\"companyId\":1,\"startTime\":\"2013-01-13T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"81的表现\"}},{\"accountNumber\":26,\"companyId\":1,\"departmentId\":1,\"positionId\":1,\"jobNumber\":26111,\"startTime\":\"2021-07-22T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":26,\"companyId\":1,\"startTime\":\"2021-07-22T00:00:00.000+08:00\",\"absenteeismRate\":\"\",\"performance\":\"\"}}],\"departments\":[{\"companyId\":1,\"departmentId\":1,\"name\":\"部门1\",\"positions\":[{\"companyId\":1,\"departmentId\":1,\"positionId\":1,\"name\":\"主管\"},{\"companyId\":1,\"departmentId\":1,\"positionId\":2,\"name\":\"经理\"}]},{\"companyId\":1,\"departmentId\":2,\"name\":\"部门2\",\"positions\":[{\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"name\":\"员工\"},{\"companyId\":1,\"departmentId\":2,\"positionId\":2,\"name\":\"经理\"}]}]}")))
                .andDo(MockMvcResultHandlers.print());
    }
...
//        String name, String legalRepresentativeName, String email, String address, String phone
    ...
    public void getDepartmentByCompanyIdTest()throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.get("/getDepartmentByCompanyId.do?companyId=1")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(Matchers.equalTo("[{\"companyId\":1,\"departmentId\":1,\"name\":\"部门1\",\"positions\":[{\"companyId\":1,\"departmentId\":1,\"positionId\":1,\"name\":\"主管\"},{\"companyId\":1,\"departmentId\":1,\"positionId\":2,\"name\":\"经理\"}]},{\"companyId\":1,\"departmentId\":2,\"name\":\"部门2\",\"positions\":[{\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"name\":\"员工\"},{\"companyId\":1,\"departmentId\":2,\"positionId\":2,\"name\":\"经理\"}]}]")))
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void getPositionByCompanyIdAndDepartmentIdTest()throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.get("/getPositionByCompanyIdAndDepartmentId.do?companyId=1&departmentId=1")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(Matchers.equalTo("[{\"companyId\":1,\"departmentId\":1,\"positionId\":1,\"name\":\"员工\"},{\"companyId\":1,\"departmentId\":1,\"positionId\":2,\"name\":\"经理\"}]")))
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void getEmployeeByCompanyIdAndDepartmentIdTest()throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders.get("/getEmployeeByCompanyIdAndDepartmentId.do?companyId=1&departmentId=2")
                ...
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().string(Matchers.equalTo("[{\"name\":\"张三\",\"birthday\":\"2000-01-10T00:00:00.000+08:00\",\"gender\":\"男\",\"email\":\"2019302110260@whu.edu.cn\",\"identifyNumber\":\"5\",\"accountNumber\":5,\"password\":\"123\",\"experiences\":[{\"accountNumber\":5,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1521,\"startTime\":\"2010-01-10T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":5,\"companyId\":1,\"startTime\":\"2010-01-10T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"51的表现\"}}]},{\"name\":\"李四\",\"birthday\":\"2001-01-11T00:00:00.000+08:00\",\"gender\":\"女\",\"email\":\"2019302110261@whu.edu.cn\",\"identifyNumber\":\"6\",\"accountNumber\":6,\"password\":\"456\",\"experiences\":[{\"accountNumber\":6,\"companyId\":1,\"departmentId\":2,\"positionId\":1,\"jobNumber\":1621,\"startTime\":\"2011-01-11T00:00:00.000+08:00\",\"endTime\":null,\"isEnd\":false,\"assessment\":{\"accountNumber\":6,\"companyId\":1,\"startTime\":\"2011-01-11T00:00:00.000+08:00\",\"absenteeismRate\":\"0/10\",\"performance\":\"61的表现\"}}]},{\"name\":\"王五\",\"birthday\":\"2002-01-12T00:00:00.000+08:00\",\"gender\":\"男\",\"email\":\"2019302110262@whu.edu.cn\",\"identifyNumber\":\"7\",\"accountNumber\":7,\"password\":\"123\",\"experiences\":[]},{\"name\":\"赵六\",\"birthday\":\"2003-01-13T00:00:00.000+08:00\",\"gender\":\"女\",\"email\":\"2019302110263@whu.edu.cn\",\"identifyNumber\":\"8\",\"accountNumber\":8,\"password\":\"456\",\"experiences\":[]}]")))
                .andDo(MockMvcResultHandlers.print());
    }
